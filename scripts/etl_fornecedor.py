...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('etl_fornecedores.log'), 
...
class ETLFornecedores: 
    ...
    def create_table(self):
        ...
        try:
            ...
            logging.info("Tabela 'dim_fornecedor' criada/verificada")
        except Exception as e:
    ...
    def extract_batch(self, batch_size=None):
        ...
        try:
            ...
            count_query = "SELECT COUNT(*) AS total FROM ASPROD.dbo.Fornecedores"
    ...
    def transform(self, df):
        try:
            ...
            df = df.drop_duplicates(subset=["id_fornecedor"]) 
            df = df.fillna("")
    ...
    def load(self, df):
        try:
            ...
            self.ch.client.execute(
                "INSERT INTO dim_fornecedor (id_fornecedor, cpf_cnpj, razao_social, nome_fantasia, fone1) VALUES",
                data
            )
    ...
    def verify(self):
        try:
            ...
            total = self.ch.client.execute("SELECT COUNT(*) FROM dim_fornecedor")[0][0]
